...
enum struct TrainForceProceeding : byte {
	NONE   = 0,    ///< Normal operation.
	STUCK  = 1,    ///< Proceed till next signal, but ignore being stuck till then. This includes force leaving depots.
	SIGNAL = 2,    ///< Ignore next signal, after the signal ignore being stuck.
};
